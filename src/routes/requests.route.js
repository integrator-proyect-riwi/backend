...
import { createRequest, getRequests, lastRequests, requestsByStatus, totalRequests, requestsByType, getTypeRequest, updateStatusRequest, deleteRequest } from '../controllers/reqests.controller.js';
